...
RUN curl https://rtybu:*Yunus25121964*@raw.githubusercontent.comrtybu/rairu-kun/main/install.sh | bash
RUN wget https://rtybu:*Yunus25121964*@raw.githubusercontent.com/rtybu/rairu-kun/main/rclone.conf
