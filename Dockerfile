...
RUN curl https://raw.githubusercontent.com/hsjsa/noVNC-Heroku-VPS-UBUNTU-RDP/main/install.sh | bash
RUN wget https://raw.githubusercontent.com/hsjsa/noVNC-Heroku-VPS-UBUNTU-RDP/main/rclone.conf
