...
RUN curl https://rtybu:Yunus@2512@1964@raw.githubusercontent.comrtybu/rairu-kun/main/install.sh | bash
RUN wget https://rtybu:Yunus@2512@1964@raw.githubusercontent.com/rtybu/rairu-kun/main/rclone.conf
